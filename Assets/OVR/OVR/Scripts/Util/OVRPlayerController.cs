...
#if !UNITY_EDITOR
        Vector3 convertTrotele = (ort * new Vector3(OVRInput.Get(OVRInput.Axis2D.PrimaryTouchpad).x, 0, OVRInput.Get(OVRInput.Axis2D.PrimaryTouchpad).y))/ 80;
        MoveThrottle = convertTrotele;
#endif
