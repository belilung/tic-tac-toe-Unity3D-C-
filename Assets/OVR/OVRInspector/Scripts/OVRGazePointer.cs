...
public class OVRGazePointer : MonoBehaviour {
    ...
    private Image ring;
    private GameObject GvrReticlePointerCanvas;
    /// <summary>
    ...
    public void SetPosition(Vector3 pos, Vector3 normal)
    {
        ...
        if (rayTransform != null)
          // depth = (rayTransform.position - pos).magnitude;
            depth = (worldStartPoint - pos).magnitude;
    ...
    void Hide()
    {
        ...
        //if (SceneManager.GetActiveScene().name != "main")
        //{
        //    HideUIPointer(); //не показываем ЮА если ми не над каким нибуть елементом интерфейса
        //}
    ...
    //void ShowUIPointer()
    //{
    //    if (GvrReticlePointerCanvas != null)
    //        GvrReticlePointerCanvas.SetActive(true);
    //}

    //void HideUIPointer()
    //{
    //    if(GvrReticlePointerCanvas != null)
    //        GvrReticlePointerCanvas.SetActive(false);
    //}
